...
- **THEN** 系统返回 200 状态码和完整配置 JSON（包含 max_concurrent_tasks、max_segment_workers、download_dir、max_consecutive_errors、default_headers、interceptor_enabled、agent_address、vpn_address、gin_mode）
...
- **THEN** 系统更新配置、持久化到 config.json、应用配置到 DownloadController、处理拦截器启停、返回 200 状态码和更新后的完整配置
